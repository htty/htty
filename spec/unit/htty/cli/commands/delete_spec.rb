...
RSpec.describe HTTY::CLI::Commands::Delete do
  describe 'class' do
    ...
    it 'should be an alias_for the expected command' do
      expect(klass.alias_for).to eq(HTTY::CLI::Commands::HttpDelete)
    end
    ...
    it 'should have the expected command_line' do
      expect(klass.command_line).to eq('d[elete]')
    end
    ...
    it 'should have the expected help' do
      expect(klass.help).to eq("Alias for \e[1mhttp-d[elete]\e[0m")
    end

    it 'should have the expected help_extended' do
      expect(klass.help_extended).to eq("Alias for \e[1mhttp-d[elete]\e[0m.")
    end

    it 'should have the expected see_also_commands' do
      expect(klass.see_also_commands).to eq([HTTY::CLI::Commands::HttpDelete])
    end
