require 'htty/cli/commands/http_options'
require 'htty/cli/commands/http_get'

RSpec.describe HTTY::CLI::Commands::HttpOptions do
  describe 'class' do
    let :klass do
      subject.class
    end
    ...
    it 'should have the expected command_line' do
      expect(klass.command_line).to eq('http-o[ptions]')
    end
    ...
    it 'should have the expected help' do
      expect(klass.help).to eq('Issues an HTTP OPTIONS using the current request')
    end
