...
RSpec.describe HTTY::CLI::Commands::Follow do
  describe 'class' do
    ...
    it 'should have the expected command_line' do
      expect(klass.command_line).to eq('fol[low]')
    end
    ...
    it 'should have the expected help' do
      expect(klass.help).to eq('Changes the address of the request to the value ' +
                               "of the response's 'Location' header")
    end

    it 'should have the expected help_extended' do
      expect(klass.help_extended).to eq('Changes the address of the request to '  +
