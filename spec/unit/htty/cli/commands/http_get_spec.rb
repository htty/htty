...
RSpec.describe HTTY::CLI::Commands::HttpGet do
  describe 'class' do
    let :klass do
      subject.class
    end
    ...
    it 'should have the expected aliases' do
      expect(klass.aliases).to eq([HTTY::CLI::Commands::Get])
    end
    ...
    it 'should have the expected command_line' do
      expect(klass.command_line).to eq('http-g[et]')
    end
    ...
    it 'should have the expected help' do
      expect(klass.help).to eq('Issues an HTTP GET using the current request')
    end
...
Any request body you may set is ignored (i.e., it is not sent as part of the request).
    ...
    it 'should have the expected see_also_commands' do
      expect(klass.see_also_commands).to eq([HTTY::CLI::Commands::Follow,
