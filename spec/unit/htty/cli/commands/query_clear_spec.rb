...
RSpec.describe HTTY::CLI::Commands::QueryClear do
  describe 'class' do
    ...
    it 'should be an alias_for the expected command' do
      expect(klass.alias_for).to eq(HTTY::CLI::Commands::QueryUnsetAll)
    end
    ...
    it 'should have the expected command_line' do
      expect(klass.command_line).to eq('query-c[lear]')
    end
    ...
    it 'should have the expected help' do
      expect(klass.help).to eq("Alias for \e[1mquery-unset-[all]\e[0m")
    end

    it 'should have the expected help_extended' do
      expect(klass.help_extended).to eq("Alias for \e[1mquery-unset-[all]\e[0m.")
    end

    it 'should have the expected see_also_commands' do
      expect(klass.see_also_commands).to eq([HTTY::CLI::Commands::QueryUnsetAll])
    end
