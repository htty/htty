...
RSpec.describe HTTY::CLI::Commands::HttpPost do
  describe 'class' do
    ...
    it 'should have the expected aliases' do
      expect(klass.aliases).to eq([HTTY::CLI::Commands::Post])
    end
    ...
    it 'should have the expected command_line' do
      expect(klass.command_line).to eq('http-po[st]')
    end
    ...
    it 'should have the expected help' do
      expect(klass.help).to eq('Issues an HTTP POST using the current request')
    end

    it 'should have the expected help_extended' do
      expect(klass.help_extended).to eq('Issues an HTTP POST using the current ' +
                                        'request.')
    end
