...
RSpec.describe HTTY::CLI::Commands::CookiesUse do
  describe 'class' do
    let :klass do
      subject.class
    end
    ...
    it 'should have the expected command_line' do
      expect(klass.command_line).to eq('cookies-u[se]')
    end
    ...
    it 'should have the expected help' do
      expect(klass.help).to eq('Uses cookies offered in the response')
    end

    it 'should have the expected help_extended' do
      expect(klass.help_extended).to eq('Sets the cookies of the request to the ' +
